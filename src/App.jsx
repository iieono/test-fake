...
function App() {
  ...
  useEffect(() => {
    if (question) {
      ...
      setQuestionData(data[questionIndex]);
    }
    console.log(questionData);
  }, [question, questionIndex, questionData]);
        ...
        <div className="w-9/12 flex justify-between items-center">
          <div className="flex gap-2 items-center">
            ...
            <input
              ...
              className="outline-none bg-transparent w-80 placeholder-transparent text-transparent"
              placeholder="Sardorbek Ismayiljon ogli Ne'matov"
            />
          </div>
          <div className="flex gap-4 items-center">
            ...
            <p className="text-lg">
              {name ? name : "Sardorbek Ismayiljon ogli Ne'matov"}
            </p>
      ...
      <div className="p-5 flex flex-col gap-5">
        ...
        <div className="flex flex-col 2xl:flex-row justify-between  gap-5 w-full h-100">
          <div className="border flex flex-col border-black/10 w-full h-50">
            <div className="flex gap-6 p-5 py-6">
              <div className="bg-[#DEE2E6] w-[124px] h-48 p-2 px-2 border flex flex-col gap-2 border-black/10">
                <div className="text-sm font-light">
                  Question <span className="font-semibold text-lg">10</span>
                </div>
                <div className="text-sm text-[#656565] font-light">
                  Not yet answered
                </div>
                <div className="text-sm text-[#656565] font-light">
                  Marked out of 1.00
              ...
              <div className="w-full text-[#656565] p-5 py-3 font-light bg-[#DEF2F8] ">
                <p className="mb-7">
                  {questionData
                    ...
                    : "Frontend Freymvork larni korsating"}
                </p>
                <div className="text-[#656565]">Select one or more:</div>
                <div className="p-2 flex flex-col gap-3">
                  {questionData &&
                    questionData?.answers?.map((item, idx) => (
            ...
            <div className="flex justify-end p-5 ">
              <div className="bg-[#88B77B] flex gap-5 text-white font-semibold px-4 py-3">
                <p onClick={() => setQuestionIndex((prev) => prev - 1)}>
                  Previous page
                </p>
                <p onClick={() => setQuestionIndex((prev) => prev + 1)}>
                  Next page
            ...
            <div className="flex justify-between font-light items-center p-5 pt-0">
              <div className="pl-4 font-extralight w-[450px] flex items-start justify-start  text-center">
                ...
                <span>
                  1-mavzu Freymvork platformalari bilan ishlash va ularning
                  imkoniyatlari
                </span>
              </div>
              ...
              <div className="pr-4 font-extralight flex items-center  justify-end w-[450px] text-end">
                <span>2-mavzu YII freymvorkiga kirish</span>
          ...
          <div className="border border-black/10 w-[520px] h-50">
            ...
            <div className="px-4 py-2 font-light bg-[#F9F9F9] text-lg">
              Finish attempt ...
            </div>
            <div className="px-4 py-1 pb-4 bg-[#F9F9F9] font-light text-[#656565]">
              Time left <span className="font-semibold">0:08:48</span>
            </div>
          </div>
        </div>
